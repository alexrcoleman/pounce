...
The live neural AI action surface can include `wait` and `premove` decisions.
Training and audit scripts keep those candidates disabled by default so old
